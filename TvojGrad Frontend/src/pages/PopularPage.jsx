...
export default function PopularPage({ navigate }) {
  ...
  if (loading) {
    return (
      <div className="main">
        <div className="empty">Ucitavanje popularnih dogadjaja...</div>
      </div>
    );
  }
  ...
  return (
    <div className="main">
      <div className="page-header">
        <div className="page-title">Najpopularniji dogadjaji</div>
        ...
        <div key={e.id} className="popular-item" onClick={() => navigate("detail", e)}>
          ...
          <div className="popular-info">
            ...
            <div className="popular-meta">
              {new Date(e.date).toLocaleDateString("sr-Latn", { day: "numeric", month: "long" })} · {e.city}
            </div>
          </div>
